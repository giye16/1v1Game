def Player_2():
    ...
    P2 = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    P2.set_position(130, 90)
    controller.player2.move_sprite(P2, 75, 0)
    P2.ay = 600
    P2.fx = 30
    aimP2 = 0
    statusbar2 = statusbars.create(20, 4, StatusBarKind.health)
    statusbar2.set_position(147, 12)
    statusbar2.value = 100

def on_player2_button_b_pressed():
    global projectile, shotP2
    if shotP2 == True:
        if aimP2 == 1:
...
def on_player2_button_up_pressed():
    if P2.is_hitting_tile(CollisionDirection.BOTTOM):
        P2.vy = -210
...
def Player_1():
    ...
    P1 = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    P1.set_position(40, 90)
    controller.player1.move_sprite(P1, 75, 0)
    P1.ay = 600
    P1.fx = 30
    aimP1 = 0
    statusbar1 = statusbars.create(20, 4, StatusBarKind.health)
    statusbar1.set_position(13, 12)
...
def on_forever():
    scene.center_camera_at(0, (P1.y + P2.y) / 2)
forever(on_forever)
